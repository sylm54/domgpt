 ...
 */
export const ConversationAutoScroll = ({ trigger: _trigger }: { trigger: number }) => {
...
export const ConversationContent = ({ className, ...props }: ConversationContentProps) => (
	<StickToBottom.Content className={cn("flex-1 overflow-y-auto p-4 pb-24", className)} {...props} />
);
